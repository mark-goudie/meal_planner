...
class GenerateStructuredShoppingListTests(TestCase):
    ...
    def test_shared_ingredient_quantities_sum(self):
        ...
        eggs_entry = next(
            e for e in shopping_list if e['ingredient'].name == 'Eggs'
        )
    ...
    def test_empty_recipe_list_returns_empty(self):
        ...
        result = RecipeService.generate_structured_shopping_list(
            Recipe.objects.none()
        )
...
class CalculateRecipeHappinessScoreTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            username='scoreuser', password='password'
        )
...
class GetRecentlyCookedRecipesTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            username='recentuser', password='password'
        )
